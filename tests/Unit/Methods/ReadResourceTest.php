...
use Crustum\Mcp\Test\Fixtures\ResourceWithResultMetaResource;
...
it('throws -32603 with exception message when ModelNotFoundException is thrown with APP_DEBUG true', function (): void {
    ...
    $resource = new class extends Resource
    {
        ...
        {
            throw new RuntimeException('No query results for model [App\Models\User] 42.');
        }
    };
...
it('preserves sessionId and meta from the original request for template resources', function (): void {
    ...
    McpContainerBindings::bindRequest($container, $jsonRpcRequest->toRequest());
