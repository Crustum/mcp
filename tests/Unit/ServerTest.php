...
use Crustum\Mcp\Test\Fixtures\CustomMethodHandler;
use Crustum\Mcp\Test\Fixtures\ExampleServer;
use Crustum\Mcp\Test\Fixtures\ThrowingMethodHandler;
...
it('handles exceptions in debug mode', function (): void {
    ...
    $this->instance(ThrowingMethodHandler::class, new class implements Method
    {
