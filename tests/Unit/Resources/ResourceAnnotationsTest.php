...
it('includes the lastModified annotation in resource', function (): void {
    $resource = new #[LastModified('2025-01-12T15:00:58Z')]
    class extends Resource
    {
        public function description(): string
        {
...
it('includes multiple annotations in resource', function (): void {
    $resource = new #[Audience(Role::User)] #[Priority(1.0)] #[LastModified('2025-01-12T15:00:58Z')]
    class extends Resource
    {
        public function description(): string
        {
...
it('includes annotations in resource toArray', function (): void {
    $resource = new #[Audience(Role::User)] #[Priority(0.5)]
    class extends Resource
    {
        public function description(): string
        {
...
it('validates audience roles', function (): void {
    expect(function (): void {
        $resource = new #[Audience(['invalid_role'])]
        class extends Resource
        {
            public function description(): string
            {
...
it('validates lastModified ISO 8601 format', function (): void {
    expect(function (): void {
        $resource = new #[LastModified('not-a-valid-timestamp')]
        class extends Resource
        {
            public function description(): string
            {
...
it('accepts valid ISO 8601 formats for lastModified', function (): void {
    $resource = new #[LastModified('2025-01-12T15:00:58+00:00')]
    class extends Resource
    {
        public function description(): string
        {
...
it('accepts only user role', function (): void {
    $resource = new #[Audience(Role::User)]
    class extends Resource
    {
        public function description(): string
        {
...
it('accepts only an assistant role', function (): void {
    $resource = new #[Audience(Role::Assistant)]
    class extends Resource
    {
        public function description(): string
        {
...
it('rejects tool annotations on resources', function (): void {
    expect(function (): void {
        ...
        $resource->annotations();
    })->toThrow(InvalidArgumentException::class, 'Annotation [Crustum\Mcp\Server\Tools\Annotations\IsReadOnly] cannot be used on');
});
